...
Begin VB.Form Frm_Main 
   ...
   Begin VB.Frame Fra_Main 
      ...
      Begin VB.Frame Fra_Menu 
         ...
         Begin Stadmis.ShapeButton ShpBttnMenu 
            ...
            bordercolorhover=   11632444
            caption         =   ""
            picture         =   "Frm_Main.frx":128C
            font            =   "Frm_Main.frx":1626
         End
         Begin Stadmis.ShapeButton ShpBttnMenu 
            Height          =   375
            Index           =   2
            ...
            bordercolorhover=   11632444
            caption         =   ""
            picture         =   "Frm_Main.frx":164E
            font            =   "Frm_Main.frx":1BE8
         End
         Begin Stadmis.ShapeButton ShpBttnMenu 
            Height          =   375
            Index           =   3
            ...
            bordercolorhover=   11632444
            caption         =   ""
            picture         =   "Frm_Main.frx":1C10
            font            =   "Frm_Main.frx":1FAA
         End
         Begin Stadmis.ShapeButton ShpBttnMenu 
            Height          =   375
            Index           =   4
            ...
            bordercolorhover=   11632444
            caption         =   ""
            picture         =   "Frm_Main.frx":1FD2
            font            =   "Frm_Main.frx":236C
         End
         Begin Stadmis.ShapeButton ShpBttnMenu 
            Height          =   375
            Index           =   5
            ...
            bordercolorhover=   11632444
            caption         =   ""
            picture         =   "Frm_Main.frx":2394
            font            =   "Frm_Main.frx":272E
         End
         Begin Stadmis.ShapeButton ShpBttnMenu 
            Height          =   375
            Index           =   6
            ...
            bordercolorhover=   11632444
            caption         =   ""
            picture         =   "Frm_Main.frx":2756
            font            =   "Frm_Main.frx":2AF0
         End
         Begin Stadmis.ShapeButton ShpBttnMenu 
            Height          =   375
            Index           =   7
            ...
            bordercolorhover=   11632444
            caption         =   ""
            picture         =   "Frm_Main.frx":2B18
            font            =   "Frm_Main.frx":2EB2
         End
         Begin Stadmis.ShapeButton ShpBttnVote 
            Height          =   375
            Left            =   7560
            TabIndex        =   56
            Tag             =   "AutoSizer:X"
            ToolTipText     =   "Vote on it at Planet-Source-Code"
            Top             =   165
            Width           =   975
            _extentx        =   1720
            _extenty        =   661
            ...
            bordercolorhover=   11632444
            caption         =   "     Vote"
            picture         =   "Frm_Main.frx":2EDA
            font            =   "Frm_Main.frx":3274
         End
   ...
   Begin MSComctlLib.ImageList ImgLst 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":329C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":3A16
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":4410
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":52EA
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":5A64
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":5DFE
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":6CF0
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":708A
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":7A84
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":7ED6
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":8328
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Frm_Main.frx":877A
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Label LblConnectionInfo 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Your computer is currently connected to the Internet."
      BeginProperty Font 
         Name            =   "Arial Narrow"
         Size            =   9
         Charset         =   0
   ...
   Begin VB.Label LblConnectionInfo 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Database Status....Online"
      BeginProperty Font 
         Name            =   "Arial Narrow"
         Size            =   9
         Charset         =   0
   ...
   Begin VB.Label lblDeveloper 
      ...
      BackStyle       =   0  'Transparent
      Caption         =   "Developed by "" & App.CompanyName & "". "" & App.LegalCopyright"
      BeginProperty Font 
         Name            =   "Arial Narrow"
         Size            =   8.25
         Charset         =   0
...
Private Sub Form_Activate()
    ...
    lblDeveloper.Caption = "Developed by " & App.CompanyName & ". " & App.LegalCopyright
    ...
    Select Case ItemCategoryNo
        ...
        Case &H6: Call MnuStudents_Click(CInt(ItemIndex))
...
Private Sub Form_Load()
    ...
    lblMenu(&H0).Caption = VBA.Year(VBA.Date) & " &Students"
    MnuStudents(&H0).Caption = VBA.Year(VBA.Date) & " Students"
...
On Local Error GoTo Handle_lblMenu_Click_Error
    ...
    Call imgBanner_MouseDown(Index, 0, 0, 0, 0)
    
    Select Case VBA.Replace(lblMenu(Index).Caption, "&", VBA.vbNullString)
        
        Case VBA.Year(VBA.Date) & " Students": 'Current year students
            
            'Display Category Title
            lblSelectedCategory(&H0).Caption = VBA.Year(VBA.Date) & " Students"
            lblSelectedCategory(&H1).Caption = "Information of every Student in the School admitted in the current year {" & VBA.Year(VBA.Date) & "}"
            ...
            Call FillListView(Lv, "SELECT ([Registered Name]) AS [Student Name], [Student ID], [Admission Date], [Adm No], [Gender], [National ID], [Phone No], [Location], [E-mail Address], [Postal Address], [Student Status] FROM [Qry_Students] WHERE YEAR([Admission Date]) = " & VBA.Year(VBA.Date) & " ORDER BY [Registered Name] ASC", "2", , "Student ID", "Student Status:<>'ACTIVE'", &HC0&, IsFrmLoadingComplete, , , &H2)
...
Private Sub lblSchoolInfo_Click(Index As Integer)
...
On Local Error GoTo Handle_MnuConfiguration_Click_Error
    ...
    Select Case Index
        ...
        Case &H5: 'Is Login Report...
            ...
            'Call Function in Mdl_Stadmis to display all the Login Records
...
On Local Error GoTo Handle_MnuConfigurationTool_Click_Error
    ...
    Select Case VBA.Replace(MnuConfigurationTool(Index).Caption, "&", VBA.vbNullString)
        ...
        Case "School Info": 'School Info...
            ...
            iPhotoSpecifications = "[Tbl_School] WHERE [School ID] = $;2;[School Name]"
...
On Local Error GoTo Handle_MnuConfiguration_Click_Error
    ...
    'Save the current Category in order to execute it when the Application is reloaded
    ItemCategoryNo = &H6: ItemIndex = Index
    ...
    Select Case Index
        ...
        Case &H1: 'All Students
            
            'Display Category Title
            lblSelectedCategory(&H0).Caption = "All Students"
            lblSelectedCategory(&H1).Caption = "Information of all the Students who are or have ever been to the School"
            ...
            'Call Function in Mdl_Stadmis to display all the Students
            Call FillListView(Lv, "SELECT ([Registered Name]) AS [Student Name], [Student ID], [Admission Date], [Adm No], [Gender], [National ID], [Phone No], [Location], [E-mail Address], [Postal Address], [Deceased], [Student Status] FROM [Qry_Students] ORDER BY [Registered Name] ASC", "2", , "Student ID", "Student Status:<>ACTIVE|Deceased:=YES", &HC0& & "|" & &HC000C0, IsFrmLoadingComplete, , , &H2)
            iPhotoSpecifications = "[Qry_Students] WHERE [Student ID] = $;2;[Student ID];Student Name"
            
        Case &H3, &H4, &H5, &H6: 'All Graduated, Transfered, Discontinued & Deceased Students
            
            'Display Category Title
            lblSelectedCategory(&H0).Caption = VBA.Replace(MnuStudents(Index).Caption, "&", "")
            lblSelectedCategory(&H1).Caption = "Information of all the " & VBA.Replace(MnuStudents(Index).Caption, "&", "") & " who are or have ever been to the School"
            ...
            'Call Function in Mdl_Stadmis to display all the Students
            Call FillListView(Lv, "SELECT ([Registered Name]) AS [Student Name], [Student ID], [Admission Date], [Adm No], [Gender], [National ID], [Phone No], [Location], [E-mail Address], [Postal Address], [Deceased], [Student Status] FROM [Qry_Students] WHERE " & VBA.Switch(Index = &H3, "[Student Status] = 'Graduated'", Index = &H4, "[Student Status] = 'Transfered'", Index = &H5, "[Student Status] = 'Discontinued'", Index = &H6, "[Deceased] = TRUE") & " ORDER BY [Registered Name] ASC", "2", , "Student ID", "Deceased:=YES", &HC000C0, IsFrmLoadingComplete, , , &H2)
            iPhotoSpecifications = "[Qry_Students] WHERE [Student ID] = $;2;[Student ID];Student Name"
...
Private Sub ShpBttnVote_Click()
    Call OpenFile(Me, def_VoteForStadmisURL, True)
End Sub
...
Private Sub TimerConnection_Timer()
    ...
    If vStatus = "Please Wait" Then
        
        'Do nothing
        
    Else
        
        Static xInterNetColor, xConnected As Boolean
        
        Dim IsConn$, msg$
        
        xConnected = IsWebConnected(msg)
        LblConnectionInfo(&H0).Caption = VBA.IIf(xConnected, "Your computer is currently fixed on " & msg & " connection type", "Your computer is currently not connected to the Internet.")
        
        'If the Computer is connected to the Internet then...
        If xConnected Then
            
            'Switch notifier color between Green and White
            ShpConnection(&H0).FillColor = VBA.IIf(xInterNetColor, &HFF00&, &HFFFFFF)
            
        Else 'If the Computer is not connected to the Internet then...
            
            'Switch notifier color between Red and Black
            ShpConnection(&H0).FillColor = VBA.IIf(xInterNetColor, &HFF&, &HFFFFFF)
        ...
        Dim vDatabasePath$
        Dim xDbConnected As Boolean
        Dim xFso As New FileSystemObject
        
        'Call Function in Mdl_Stadmis Module to connect to Software's Database
        If VBA.LenB(VBA.Trim$(vAdoCNN.ConnectionString)) = &H0 Then Call ConnectDB(, False)
        
        vDatabasePath = vAdoCNN.Properties("Data Source")
        
        'Check if the database exists in the retrieved path
        xDbConnected = xFso.FileExists(vDatabasePath)
        
        LblConnectionInfo(&H1).Caption = VBA.IIf(xDbConnected, "Database Status..Online", "Database Status..Offline")
        
        'If the Software has been linked to its database then...
        If xDbConnected Then
            
            'Switch notifier color between Green and White
            ShpConnection(&H1).FillColor = VBA.IIf(xInterNetColor, &HFF00&, vbWhite)
            
        Else 'If the Software has not been linked to its database then...
            
            'Switch notifier color between Red and Black
            ShpConnection(&H1).FillColor = VBA.IIf(xInterNetColor, &HFF&, vbBlack)
            
        End If 'Close respective IF..THEN block statement
        
        xInterNetColor = Not xInterNetColor
