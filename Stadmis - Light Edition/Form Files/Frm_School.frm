...
On Local Error GoTo Handle_chkDiscontinued_Click_Error
    ...
    If chkDiscontinued.Value = vbChecked Then If vMsgBox("Ticking this option will disable the School's Record and will not be available in other Modules. Proceed?", vbQuestion + vbYesNo + vbDefaultButton2, App.Title & " : Confirmation") = vbNo Then myRecDisplayON = True: chkDiscontinued.Value = vbUnchecked: myRecDisplayON = False
